...
def init_db(my_username, my_password):
    ...
    prod4 = Productivity(item="Email", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod5 = Productivity(item="WhatsApp", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod6 = Productivity(item="Telegram", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod7 = Productivity(item="Messenger", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod8 = Productivity(item="Photo", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
