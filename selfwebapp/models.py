...
def init_db(my_username, my_password):
    ...
    prod7 = Productivity(item="Photos", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow(), category="Photos")
    prod8 = Productivity(item="Photos - Albums", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow(), category="Photos")
    prod9 = Productivity(item="CNET Tech Today", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow(), category="News")
    prod10 = Productivity(item="Emails", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow(), category="News")
