...
def init_db(my_username, my_password):
    ...
    prod6 = Productivity(item="Teams", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod7 = Productivity(item="Photos", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod8 = Productivity(item="Photos - Albums", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod9 = Productivity(item="CNET Tech Today", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
    prod10 = Productivity(item="Emails", last_check=datetime.utcnow(), last_check_previous=datetime.utcnow())
